        ...
        <>
            ...
            <MapAnimation
                steps={[
                    ...
                    {type: 'fly', center: CONSTS.JACAREI_CENTER, zoom: CONSTS.JACAREI_ZOOM, delayMs: 600, durationSec: 2},
                    {type: 'wait', delayMs: 1500},
                    {type: 'fitLayer', layerRef: jacareiLayerRef, padding: [4, 4], delayMs: 600, durationSec: 2}
                ]}
                onComplete={() => {
                    return;
                }}
